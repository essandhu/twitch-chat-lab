...
export const PerfOverlay = () => {
  ...
  return (
    <aside
      ...
      className="fixed bottom-4 right-4 z-[9999] w-64 border border-ink-800 bg-ink-950/90 backdrop-blur px-3 py-3 font-mono"
    >
      <div className="mb-2 text-[10px] uppercase tracking-[0.3em] text-ink-500">
        perf · live
      </div>
